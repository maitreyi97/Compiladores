...
happyTokenStrings = ["'('","')'","'+'","'*'","'|'","literal","eof","%eof"]

happyActOffsets :: HappyAddr
happyActOffsets = HappyA# ""#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# ""#

happyDefActions :: HappyAddr
happyDefActions = HappyA# ""#

happyCheck :: HappyAddr
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#
...
happyRuleArr = HappyA# ""#
...
happyReduction_4 (HappyAbsSyn7  happy_var_2)
        (HappyAbsSyn8  happy_var_1)
         =  HappyAbsSyn7
                 (Concat happy_var_1 happy_var_2
        )
...
happyReduction_9 (HappyTerminal (TokenLiteral happy_var_1))
         =  HappyAbsSyn9
                 (Literal happy_var_1
        )
...
happyTerminalToTok term = case term of {
        ...
        TokenRep -> 5#;
        TokenOr -> 6#;
        TokenLiteral happy_dollar_dollar -> 7#;
        TokenEOF -> 8#;
        _ -> -1#;
        }
...
parseRegex tks = happyRunIdentity happySomeParser where
