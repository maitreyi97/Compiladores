...
happyExpList = Happy_Data_Array.listArray (0,34) ([8448,8448,16384,4096,8448,3072,8448,0,0,512,0,0,0,8448,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseRegex","Regex","Disyuncion","Concatenacion","Repeticion","Base","'('","')'","'+'","'*'","'|'","literal","eof","%eof"]
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenRep -> cont 12;
	TokenOr -> cont 13;
	TokenLiteral happy_dollar_dollar -> cont 14;
	TokenEOF -> cont 15;
	_ -> happyError' ((tk:tks), [])
	}
